	...
	return (
		<div>
			<div className="flex justify-between items-start mb-6">
				<div>
					<h1 className="text-2xl font-bold text-gray-800">Auditorías de Historias Clínicas</h1>
					<p className="text-gray-600 mt-2">Gestión integral de auditorías del sistema de historias clínicas</p>
				</div>
				<button
