...
const ResumenAuditoria = ({ data }) => {
    ...
    return (
        <div className="mx-auto my-8 bg-white dark:bg-gray-800 shadow-lg dark:shadow-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            {/* Header mejorado */}
            <div className="flex items-center p-5 bg-gradient-to-r from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/30 border-b border-gray-200 dark:border-gray-700">
                <BarChart3 className="w-6 h-6 text-blue-600 dark:text-blue-400 mr-3" />
                <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Resumen de Auditoría</h2>
            </div>

            {/* Cuerpo mejorado */}
            <div className="grid grid-cols-1 md:grid-cols-3 divide-x-0 md:divide-x divide-y md:divide-y-0 divide-gray-100 dark:divide-gray-700">
                {/* Puntaje Total */}
                <div className="flex flex-col items-center justify-center p-6 bg-white dark:bg-gray-800">
                    <div className="flex items-center mb-3">
                        ...
                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Puntaje Total</p>
                    </div>
                ...
                {/* Porcentaje */}
                <div className="flex flex-col items-center justify-center p-6 bg-blue-50/30 dark:bg-blue-900/20">
                    <div className="flex items-center mb-3">
                    ...
                    <div className="relative">
                        <p className="text-4xl font-bold text-blue-600 dark:text-blue-400">{porcentaje}%</p>
                        <div className="absolute -top-2 -right-6">
                            <div className={`w-3 h-3 rounded-full animate-pulse ${porcentaje >= 95 ? 'bg-green-500 dark:bg-green-400' :
                                    porcentaje >= 85 ? 'bg-yellow-500 dark:bg-yellow-400' : 'bg-red-500 dark:bg-red-400'
                                }`}></div>
                        </div>
                    </div>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">de cumplimiento</p>
                </div>
