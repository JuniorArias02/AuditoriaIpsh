        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold text-gray-900">Dimensiones de Auditoría</h2>
                        <p className="text-sm text-gray-600">Organiza las dimensiones y sus criterios de evaluación</p>
                    </div>
                </div>
                ...
                <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all"
                >
                    <Plus size={18} />
                    Agregar Dimensión
                </motion.button>
            ...
            {dimensiones.length === 0 && (
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="text-center py-12 bg-white/50 rounded-2xl border-2 border-dashed border-gray-300"
                >
