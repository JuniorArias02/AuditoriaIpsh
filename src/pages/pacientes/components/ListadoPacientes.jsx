  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {virtualItems.map((virtualRow) => {
            ...
            return (
              <div
                ...
                className="flex px-6 py-4 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700"
              >
                <div className="flex-1 flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-900 dark:text-white">{pac.nombre_completo}</div>
      ...
      <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
        Mostrando <span className="font-medium text-gray-900 dark:text-white">{pacientes.length}</span> de <span className="font-medium text-gray-900 dark:text-white">{total}</span> pacientes
      </div>
    </div>
  );
}
